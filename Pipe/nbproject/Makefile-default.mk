...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Pipe.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=../NexOS/Ports/PIC32MX/ContextSwitch.S ../NexOS/Ports/PIC32MX/CriticalSection.c ../NexOS/Ports/PIC32MX/Port.c ../NexOS/Kernel/Kernel.c ../NexOS/Kernel/Memory.c ../NexOS/Kernel/Task.c ../NexOS/Kernel/KernelTasks.c main.c HardwareProfile.c ../NexOS/Pipe/Pipe.c "../Generic Libraries/Double Linked List/DoubleLinkedList.c" "../Generic Libraries/Generic Buffer/GenericBuffer.c"

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/961931426/ContextSwitch.o ${OBJECTDIR}/_ext/961931426/CriticalSection.o ${OBJECTDIR}/_ext/961931426/Port.o ${OBJECTDIR}/_ext/918398346/Kernel.o ${OBJECTDIR}/_ext/918398346/Memory.o ${OBJECTDIR}/_ext/918398346/Task.o ${OBJECTDIR}/_ext/918398346/KernelTasks.o ${OBJECTDIR}/main.o ${OBJECTDIR}/HardwareProfile.o ${OBJECTDIR}/_ext/365677095/Pipe.o ${OBJECTDIR}/_ext/1079146332/DoubleLinkedList.o ${OBJECTDIR}/_ext/935638537/GenericBuffer.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/961931426/ContextSwitch.o.d ${OBJECTDIR}/_ext/961931426/CriticalSection.o.d ${OBJECTDIR}/_ext/961931426/Port.o.d ${OBJECTDIR}/_ext/918398346/Kernel.o.d ${OBJECTDIR}/_ext/918398346/Memory.o.d ${OBJECTDIR}/_ext/918398346/Task.o.d ${OBJECTDIR}/_ext/918398346/KernelTasks.o.d ${OBJECTDIR}/main.o.d ${OBJECTDIR}/HardwareProfile.o.d ${OBJECTDIR}/_ext/365677095/Pipe.o.d ${OBJECTDIR}/_ext/1079146332/DoubleLinkedList.o.d ${OBJECTDIR}/_ext/935638537/GenericBuffer.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/961931426/ContextSwitch.o ${OBJECTDIR}/_ext/961931426/CriticalSection.o ${OBJECTDIR}/_ext/961931426/Port.o ${OBJECTDIR}/_ext/918398346/Kernel.o ${OBJECTDIR}/_ext/918398346/Memory.o ${OBJECTDIR}/_ext/918398346/Task.o ${OBJECTDIR}/_ext/918398346/KernelTasks.o ${OBJECTDIR}/main.o ${OBJECTDIR}/HardwareProfile.o ${OBJECTDIR}/_ext/365677095/Pipe.o ${OBJECTDIR}/_ext/1079146332/DoubleLinkedList.o ${OBJECTDIR}/_ext/935638537/GenericBuffer.o

# Source Files
SOURCEFILES=../NexOS/Ports/PIC32MX/ContextSwitch.S ../NexOS/Ports/PIC32MX/CriticalSection.c ../NexOS/Ports/PIC32MX/Port.c ../NexOS/Kernel/Kernel.c ../NexOS/Kernel/Memory.c ../NexOS/Kernel/Task.c ../NexOS/Kernel/KernelTasks.c main.c HardwareProfile.c ../NexOS/Pipe/Pipe.c ../Generic Libraries/Double Linked List/DoubleLinkedList.c ../Generic Libraries/Generic Buffer/GenericBuffer.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Pipe.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/365677095/Pipe.o: ../NexOS/Pipe/Pipe.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -D_SUPPRESS_PLIB_WARNING -DSIMULATION -I"../NexOS/Ports/PIC32MX" -I"E:/Source Checkouts/NexOS Projects/Pipe" -Wall -MMD -MF "${OBJECTDIR}/_ext/365677095/Pipe.o.d" -o ${OBJECTDIR}/_ext/365677095/Pipe.o ../NexOS/Pipe/Pipe.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
	@${FIXDEPS} "${OBJECTDIR}/_ext/365677095/Pipe.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/_ext/935638537/GenericBuffer.o: ../Generic\ Libraries/Generic\ Buffer/GenericBuffer.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/935638537/GenericBuffer.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/_ext/961931426/CriticalSection.o: ../NexOS/Ports/PIC32MX/CriticalSection.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/961931426/CriticalSection.o.d 
	@${RM} ${OBJECTDIR}/_ext/961931426/CriticalSection.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -D_SUPPRESS_PLIB_WARNING -DSIMULATION -I"../NexOS/Ports/PIC32MX" -I"E:/Source Checkouts/NexOS Projects/Pipe" -Wall -MMD -MF "${OBJECTDIR}/_ext/961931426/CriticalSection.o.d" -o ${OBJECTDIR}/_ext/961931426/CriticalSection.o ../NexOS/Ports/PIC32MX/CriticalSection.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
	@${FIXDEPS} "${OBJECTDIR}/_ext/961931426/CriticalSection.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/main.o: main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/main.o.d 
	@${RM} ${OBJECTDIR}/main.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -D_SUPPRESS_PLIB_WARNING -DSIMULATION -I"../NexOS/Ports/PIC32MX" -I"E:/Source Checkouts/NexOS Projects/Pipe" -Wall -MMD -MF "${OBJECTDIR}/main.o.d" -o ${OBJECTDIR}/main.o main.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
	@${FIXDEPS} "${OBJECTDIR}/main.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Pipe.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -g -mdebugger -D__MPLAB_DEBUGGER_SIMULATOR=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Pipe.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)      -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-D=__DEBUG_D,--defsym=__MPLAB_DEBUGGER_SIMULATOR=1,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -mdfp="${DFP_DIR}"
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Pipe.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Pipe.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -mdfp="${DFP_DIR}"
	${MP_CC_DIR}\\xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/Pipe.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
