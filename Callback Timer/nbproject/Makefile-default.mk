...
SOURCEFILES_QUOTED_IF_SPACED="../Generic Libraries/Double Linked List/DoubleLinkedList.c" ../NexOS/Ports/PIC32MX/Port.c ../NexOS/Ports/PIC32MX/CriticalSection.c ../NexOS/Ports/PIC32MX/ContextSwitch.S ../NexOS/Kernel/Kernel.c ../NexOS/Kernel/Memory.c ../NexOS/Kernel/Task.c ../NexOS/Kernel/KernelTasks.c ../NexOS/Timer/SoftwareTimer.c "../NexOS/Timer/Callback Timer/CallbackTimer.c" main.c HardwareProfile.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1079146332/DoubleLinkedList.o ${OBJECTDIR}/_ext/961931426/Port.o ${OBJECTDIR}/_ext/961931426/CriticalSection.o ${OBJECTDIR}/_ext/961931426/ContextSwitch.o ${OBJECTDIR}/_ext/918398346/Kernel.o ${OBJECTDIR}/_ext/918398346/Memory.o ${OBJECTDIR}/_ext/918398346/Task.o ${OBJECTDIR}/_ext/918398346/KernelTasks.o ${OBJECTDIR}/_ext/1545220628/SoftwareTimer.o ${OBJECTDIR}/_ext/2009902637/CallbackTimer.o ${OBJECTDIR}/main.o ${OBJECTDIR}/HardwareProfile.o
...
# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1079146332/DoubleLinkedList.o ${OBJECTDIR}/_ext/961931426/Port.o ${OBJECTDIR}/_ext/961931426/CriticalSection.o ${OBJECTDIR}/_ext/961931426/ContextSwitch.o ${OBJECTDIR}/_ext/918398346/Kernel.o ${OBJECTDIR}/_ext/918398346/Memory.o ${OBJECTDIR}/_ext/918398346/Task.o ${OBJECTDIR}/_ext/918398346/KernelTasks.o ${OBJECTDIR}/_ext/1545220628/SoftwareTimer.o ${OBJECTDIR}/_ext/2009902637/CallbackTimer.o ${OBJECTDIR}/main.o ${OBJECTDIR}/HardwareProfile.o

# Source Files
SOURCEFILES=../Generic Libraries/Double Linked List/DoubleLinkedList.c ../NexOS/Ports/PIC32MX/Port.c ../NexOS/Ports/PIC32MX/CriticalSection.c ../NexOS/Ports/PIC32MX/ContextSwitch.S ../NexOS/Kernel/Kernel.c ../NexOS/Kernel/Memory.c ../NexOS/Kernel/Task.c ../NexOS/Kernel/KernelTasks.c ../NexOS/Timer/SoftwareTimer.c ../NexOS/Timer/Callback Timer/CallbackTimer.c main.c HardwareProfile.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Callback_Timer.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/2009902637/CallbackTimer.o: ../NexOS/Timer/Callback\ Timer/CallbackTimer.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -DSIMULATION -D_SUPPRESS_PLIB_WARNING -I"../NexOS/Ports/PIC32MX" -I"../Callback Timer" -Wall -MMD -MF "${OBJECTDIR}/_ext/2009902637/CallbackTimer.o.d" -o ${OBJECTDIR}/_ext/2009902637/CallbackTimer.o "../NexOS/Timer/Callback Timer/CallbackTimer.c"    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
	@${FIXDEPS} "${OBJECTDIR}/_ext/2009902637/CallbackTimer.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/_ext/918398346/Task.o: ../NexOS/Kernel/Task.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/918398346/Task.o.d 
	@${RM} ${OBJECTDIR}/_ext/918398346/Task.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -DSIMULATION -D_SUPPRESS_PLIB_WARNING -I"../NexOS/Ports/PIC32MX" -I"../Callback Timer" -Wall -MMD -MF "${OBJECTDIR}/_ext/918398346/Task.o.d" -o ${OBJECTDIR}/_ext/918398346/Task.o ../NexOS/Kernel/Task.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
	@${FIXDEPS} "${OBJECTDIR}/_ext/918398346/Task.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/main.o: main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/main.o.d 
	@${RM} ${OBJECTDIR}/main.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -DSIMULATION -D_SUPPRESS_PLIB_WARNING -I"../NexOS/Ports/PIC32MX" -I"../Callback Timer" -Wall -MMD -MF "${OBJECTDIR}/main.o.d" -o ${OBJECTDIR}/main.o main.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
	@${FIXDEPS} "${OBJECTDIR}/main.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/HardwareProfile.o: HardwareProfile.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/HardwareProfile.o.d 
	@${RM} ${OBJECTDIR}/HardwareProfile.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -DSIMULATION -D_SUPPRESS_PLIB_WARNING -I"../NexOS/Ports/PIC32MX" -I"../Callback Timer" -Wall -MMD -MF "${OBJECTDIR}/HardwareProfile.o.d" -o ${OBJECTDIR}/HardwareProfile.o HardwareProfile.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
	@${FIXDEPS} "${OBJECTDIR}/HardwareProfile.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ 
...
dist/${CND_CONF}/${IMAGE_TYPE}/Callback_Timer.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) -g -mdebugger -D__MPLAB_DEBUGGER_SIMULATOR=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Callback_Timer.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)      -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-D=__DEBUG_D,--defsym=__MPLAB_DEBUGGER_SIMULATOR=1,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -mdfp="${DFP_DIR}"
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Callback_Timer.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Callback_Timer.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -mdfp="${DFP_DIR}"
