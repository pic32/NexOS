...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Simple_Semaphore.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED="../Generic Libraries/Double Linked List/DoubleLinkedList.c" ../NexOS/Ports/PIC32MX/CriticalSection.c ../NexOS/Ports/PIC32MX/Port.c ../NexOS/Ports/PIC32MX/ContextSwitch.S ../NexOS/Semaphore/OS_BinarySemaphore.c "../NexOS/Semaphore/Binary Semaphore/BinarySemaphore.c" ../NexOS/Kernel/Kernel.c ../NexOS/Kernel/Memory.c ../NexOS/Kernel/Task.c ../NexOS/Kernel/KernelTasks.c main.c HardwareProfile.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1079146332/DoubleLinkedList.o ${OBJECTDIR}/_ext/961931426/CriticalSection.o ${OBJECTDIR}/_ext/961931426/Port.o ${OBJECTDIR}/_ext/961931426/ContextSwitch.o ${OBJECTDIR}/_ext/1152203115/OS_BinarySemaphore.o ${OBJECTDIR}/_ext/2074963703/BinarySemaphore.o ${OBJECTDIR}/_ext/918398346/Kernel.o ${OBJECTDIR}/_ext/918398346/Memory.o ${OBJECTDIR}/_ext/918398346/Task.o ${OBJECTDIR}/_ext/918398346/KernelTasks.o ${OBJECTDIR}/main.o ${OBJECTDIR}/HardwareProfile.o
...
# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1079146332/DoubleLinkedList.o ${OBJECTDIR}/_ext/961931426/CriticalSection.o ${OBJECTDIR}/_ext/961931426/Port.o ${OBJECTDIR}/_ext/961931426/ContextSwitch.o ${OBJECTDIR}/_ext/1152203115/OS_BinarySemaphore.o ${OBJECTDIR}/_ext/2074963703/BinarySemaphore.o ${OBJECTDIR}/_ext/918398346/Kernel.o ${OBJECTDIR}/_ext/918398346/Memory.o ${OBJECTDIR}/_ext/918398346/Task.o ${OBJECTDIR}/_ext/918398346/KernelTasks.o ${OBJECTDIR}/main.o ${OBJECTDIR}/HardwareProfile.o

# Source Files
SOURCEFILES=../Generic Libraries/Double Linked List/DoubleLinkedList.c ../NexOS/Ports/PIC32MX/CriticalSection.c ../NexOS/Ports/PIC32MX/Port.c ../NexOS/Ports/PIC32MX/ContextSwitch.S ../NexOS/Semaphore/OS_BinarySemaphore.c ../NexOS/Semaphore/Binary Semaphore/BinarySemaphore.c ../NexOS/Kernel/Kernel.c ../NexOS/Kernel/Memory.c ../NexOS/Kernel/Task.c ../NexOS/Kernel/KernelTasks.c main.c HardwareProfile.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Simple_Semaphore.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/961931426/ContextSwitch.o: ../NexOS/Ports/PIC32MX/ContextSwitch.S  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_AS_PRE)  -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"../Simple Semaphore" -MMD -MF "${OBJECTDIR}/_ext/961931426/ContextSwitch.o.d"  -o ${OBJECTDIR}/_ext/961931426/ContextSwitch.o ../NexOS/Ports/PIC32MX/ContextSwitch.S  -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  -Wa,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_AS_POST),-MD="${OBJECTDIR}/_ext/961931426/ContextSwitch.o.asm.d",--defsym=__MPLAB_DEBUG=1,--gdwarf-2,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_SIMULATOR=1 -mdfp="${DFP_DIR}"
...
${OBJECTDIR}/_ext/961931426/ContextSwitch.o: ../NexOS/Ports/PIC32MX/ContextSwitch.S  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/961931426/ContextSwitch.o 
	@${RM} ${OBJECTDIR}/_ext/961931426/ContextSwitch.o.ok ${OBJECTDIR}/_ext/961931426/ContextSwitch.o.err 
	${MP_CC} $(MP_EXTRA_AS_PRE)  -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"../Simple Semaphore" -MMD -MF "${OBJECTDIR}/_ext/961931426/ContextSwitch.o.d"  -o ${OBJECTDIR}/_ext/961931426/ContextSwitch.o ../NexOS/Ports/PIC32MX/ContextSwitch.S  -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  -Wa,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_AS_POST),-MD="${OBJECTDIR}/_ext/961931426/ContextSwitch.o.asm.d",--gdwarf-2 -mdfp="${DFP_DIR}"
	@${FIXDEPS} "${OBJECTDIR}/_ext/961931426/ContextSwitch.o.d" "${OBJECTDIR}/_ext/961931426/ContextSwitch.o.asm.d" -t $(SILENT) -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/_ext/1079146332/DoubleLinkedList.o: ../Generic\ Libraries/Double\ Linked\ List/DoubleLinkedList.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -D_SUPPRESS_PLIB_WARNING -DSIMULATION -D_DISABLE_OPENADC10_CONFIGPORT_WARNING -I"../NexOS/Ports/PIC32MX" -I"../Simple Semaphore" -Wall -MMD -MF "${OBJECTDIR}/_ext/1079146332/DoubleLinkedList.o.d" -o ${OBJECTDIR}/_ext/1079146332/DoubleLinkedList.o "../Generic Libraries/Double Linked List/DoubleLinkedList.c"    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
...
${OBJECTDIR}/_ext/961931426/CriticalSection.o: ../NexOS/Ports/PIC32MX/CriticalSection.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -D_SUPPRESS_PLIB_WARNING -DSIMULATION -D_DISABLE_OPENADC10_CONFIGPORT_WARNING -I"../NexOS/Ports/PIC32MX" -I"../Simple Semaphore" -Wall -MMD -MF "${OBJECTDIR}/_ext/961931426/CriticalSection.o.d" -o ${OBJECTDIR}/_ext/961931426/CriticalSection.o ../NexOS/Ports/PIC32MX/CriticalSection.c    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
...
${OBJECTDIR}/_ext/961931426/Port.o: ../NexOS/Ports/PIC32MX/Port.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -D_SUPPRESS_PLIB_WARNING -DSIMULATION -D_DISABLE_OPENADC10_CONFIGPORT_WARNING -I"../NexOS/Ports/PIC32MX" -I"../Simple Semaphore" -Wall -MMD -MF "${OBJECTDIR}/_ext/961931426/Port.o.d" -o ${OBJECTDIR}/_ext/961931426/Port.o ../NexOS/Ports/PIC32MX/Port.c    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
...
${OBJECTDIR}/_ext/1152203115/OS_BinarySemaphore.o: ../NexOS/Semaphore/OS_BinarySemaphore.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -D_SUPPRESS_PLIB_WARNING -DSIMULATION -D_DISABLE_OPENADC10_CONFIGPORT_WARNING -I"../NexOS/Ports/PIC32MX" -I"../Simple Semaphore" -Wall -MMD -MF "${OBJECTDIR}/_ext/1152203115/OS_BinarySemaphore.o.d" -o ${OBJECTDIR}/_ext/1152203115/OS_BinarySemaphore.o ../NexOS/Semaphore/OS_BinarySemaphore.c    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
...
${OBJECTDIR}/_ext/2074963703/BinarySemaphore.o: ../NexOS/Semaphore/Binary\ Semaphore/BinarySemaphore.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -D_SUPPRESS_PLIB_WARNING -DSIMULATION -D_DISABLE_OPENADC10_CONFIGPORT_WARNING -I"../NexOS/Ports/PIC32MX" -I"../Simple Semaphore" -Wall -MMD -MF "${OBJECTDIR}/_ext/2074963703/BinarySemaphore.o.d" -o ${OBJECTDIR}/_ext/2074963703/BinarySemaphore.o "../NexOS/Semaphore/Binary Semaphore/BinarySemaphore.c"    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
...
${OBJECTDIR}/_ext/918398346/Kernel.o: ../NexOS/Kernel/Kernel.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -D_SUPPRESS_PLIB_WARNING -DSIMULATION -D_DISABLE_OPENADC10_CONFIGPORT_WARNING -I"../NexOS/Ports/PIC32MX" -I"../Simple Semaphore" -Wall -MMD -MF "${OBJECTDIR}/_ext/918398346/Kernel.o.d" -o ${OBJECTDIR}/_ext/918398346/Kernel.o ../NexOS/Kernel/Kernel.c    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
...
${OBJECTDIR}/_ext/918398346/Task.o: ../NexOS/Kernel/Task.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -D_SUPPRESS_PLIB_WARNING -DSIMULATION -D_DISABLE_OPENADC10_CONFIGPORT_WARNING -I"../NexOS/Ports/PIC32MX" -I"../Simple Semaphore" -Wall -MMD -MF "${OBJECTDIR}/_ext/918398346/Task.o.d" -o ${OBJECTDIR}/_ext/918398346/Task.o ../NexOS/Kernel/Task.c    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
...
${OBJECTDIR}/_ext/918398346/KernelTasks.o: ../NexOS/Kernel/KernelTasks.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -D_SUPPRESS_PLIB_WARNING -DSIMULATION -D_DISABLE_OPENADC10_CONFIGPORT_WARNING -I"../NexOS/Ports/PIC32MX" -I"../Simple Semaphore" -Wall -MMD -MF "${OBJECTDIR}/_ext/918398346/KernelTasks.o.d" -o ${OBJECTDIR}/_ext/918398346/KernelTasks.o ../NexOS/Kernel/KernelTasks.c    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
...
${OBJECTDIR}/_ext/1079146332/DoubleLinkedList.o: ../Generic\ Libraries/Double\ Linked\ List/DoubleLinkedList.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1079146332/DoubleLinkedList.o.d 
	@${RM} ${OBJECTDIR}/_ext/1079146332/DoubleLinkedList.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -D_SUPPRESS_PLIB_WARNING -DSIMULATION -D_DISABLE_OPENADC10_CONFIGPORT_WARNING -I"../NexOS/Ports/PIC32MX" -I"../Simple Semaphore" -Wall -MMD -MF "${OBJECTDIR}/_ext/1079146332/DoubleLinkedList.o.d" -o ${OBJECTDIR}/_ext/1079146332/DoubleLinkedList.o "../Generic Libraries/Double Linked List/DoubleLinkedList.c"    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
	@${FIXDEPS} "${OBJECTDIR}/_ext/1079146332/DoubleLinkedList.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Simple_Semaphore.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -g -mdebugger -D__MPLAB_DEBUGGER_SIMULATOR=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Simple_Semaphore.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)      -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-D=__DEBUG_D,--defsym=__MPLAB_DEBUGGER_SIMULATOR=1,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -mdfp="${DFP_DIR}"
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Simple_Semaphore.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Simple_Semaphore.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -mdfp="${DFP_DIR}"
	${MP_CC_DIR}\\xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/Simple_Semaphore.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
